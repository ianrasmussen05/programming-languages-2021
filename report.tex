...
First you need to \href{https://www.latex-project.org/get/}{download and install} LaTeX. Alternatively, you can use an online editor such as \href{https://www.overleaf.com/learn}{Overleaf}. I prefer to have my own installation, but to get started Overleaf may be easier. 
...
\item I think a good way to learn LaTeX is by starting from this template file and build it up step by step. Often stackoverflow will answer your questions. But here are a few resources:
  ...
  \item \href{https://www.latex-project.org/}{LaTeX – A document preparation system} \dots by the way, you can change the color of the links \ldots
\end{enumerate}
\end{itemize}
