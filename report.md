...
- **String Rewriting.** Confluence, normal forms, termination, invariants and [string rewriting exercises](https://hackmd.io/@alexhkurz/Syn23oMHF). (Recommended.) For more challenges have a look at the Baader-Nipkow book. You could for example take some other proof of the book and treat in the way we have done [here](https://hackmd.io/@alexhkurz/BkNlJ07IY).
